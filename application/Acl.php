...
class ACL
{
    ...
    public function __construct($id = false)
    {
        ...
        $this->_db = new Database(DB_TYPE, DB_HOST, DB_NOME, DB_USER, DB_PASS);
    ...
    {
        $role = $this->_db->query(
                "select nivel from tbl_usuarios " .
    ...
    {
        $ids = $this->_db->query(
                "select permiso from tbl_permisos_role " .
    ...
    public function getPermisoNombre($permisoID)
    {
        ...
        $key = $this->_db->query(
                "select `permiso` from tbl_permisos " .
                "where id_permiso = {$permisoID}"
                );
    ...
    public function getPermisosUsuario()
    {
        ...
        if(count($ids)){
            $permisos = $this->_db->query(
                    "select * from tbl_permisos_usuario " .
